...
✅ Удалены все пользователи из базы данных на сервере (для тестирования регистрации первого администратора)
✅ Исправлена проблема бесконечного редиректа - токен теперь очищается при ошибке 401 на страницах логина/регистрации
✅ Добавлена автоматическая очистка токена при загрузке страниц логина и регистрации для предотвращения проблем с невалидными токенами
