...
- React error #31 при попытке отрендерить объект ошибки валидации
...
- Добавлена функция `extractErrorMessage()` для нормализации ошибок валидации в UI
- Функция корректно обрабатывает массивы, объекты и строки, защищая от React error #31

**Файлы:**
- `backend/src/modules/auth/auth.service.ts` - унифицирована нормализация во всех методах
- `admin/app/telegram/TelegramAuthTab.tsx` - добавлена функция `extractErrorMessage()`
