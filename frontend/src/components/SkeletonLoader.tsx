...
export function AppointmentCardSkeleton() {
  return (
    <div className="bg-card rounded-lg shadow-md p-4 mb-4 animate-pulse border border-border">
  ...
  return (
    <div className="min-h-screen bg-background p-4">
      <div className="max-w-2xl mx-auto">
        <div className="bg-card rounded-lg shadow-md p-6 mb-6 animate-pulse border border-border">
